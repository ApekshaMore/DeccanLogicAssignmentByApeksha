    ...
    render() { 
        return ( 
            <div>
                ...
                <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-list" fill="white" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M2.5 11.5A.5.5 0 0 1 3 11h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 7h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4A.5.5 0 0 1 3 3h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                </svg>
                <a className="navbar-brand" href="#" style={{color:'brown', fontFamily:"Sans-serif" ,fontSize:15 , marginLeft:5}}>Advancing For Humanity</a>
                ...
                <svg style={{marginRight:7}} width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-bell-fill" fill="white" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
                </svg>          
                                
                <svg style={{marginRight:7}}  width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-people-fill" fill="white" xmlns="http://www.w3.org/2000/svg">
               ...
               <svg style={{marginRight:2}}  width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-chat-left-text-fill" fill="white" xmlns="http://www.w3.org/2000/svg">
